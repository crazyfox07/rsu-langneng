...
class CommandReceiveSet(object):
    ...
    def parse_b4(self, b4):
        ...
        self.info_b4['VehicleLicencePlateNumber'] = self.info_b4['VehicleFile'][:24]  # 车牌号
        self.info_b4['VehicleLicencePlateColor'] = self.info_b4['VehicleFile'][24:28]  # 车牌颜色
        self.info_b4['VehicleClass'] = self.info_b4['VehicleFile'][28:30]  # 车型
        self.info_b4['VehicleUserType'] = self.info_b4['VehicleFile'][30:32]  # 车辆用户类型
        ...
        self.info_b4['VehicleLicencePlateNumberReserved'] = self.info_b4['ICCFile0015'][56:80]  # 车牌号
        self.info_b4['VehicleUserTypeReserved'] = self.info_b4['ICCFile0015'][80:82]  # 用户类型
        self.info_b4['VehicleLicencePlateColorReserved'] = self.info_b4['ICCFile0015'][82:84]  # 车牌颜色
        self.info_b4['VehicleClassReserved'] = self.info_b4['ICCFile0015'][84:86]  # 车型
        return self.info_b4
