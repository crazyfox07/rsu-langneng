...
class RsuSocket(object):
    ...
    def fee_deduction(self, obu_body: VehicleOweOrm):
        """
        ...
        logger.info('==========================================开始扣费==========================================')
        logger.info('车牌号：{}， 车牌颜色：{}'.format(obu_body.plate_no, obu_body.plate_color))
        ...
        while True:
            ...
            if msg_str[8:10] == 'b2':
                ...
                logger.info('扣费金额： {}'.format(consume_money))
    ...
    def handle_data(self, body: VehicleOweOrm):
        ...
        params = dict(algorithm_type="1",
                      ...
                      plate_color_code=body.plate_color,  # 车牌颜色编码 0:蓝色、1:黄色、2:黑色、3:白色、4:渐变绿色、5:黄绿双拼、6:绿色、7:蓝白渐变
                      ...
                      # TODO 应收金额
                      receivable_total_amount=CommonUtil.yuan_to_fen(body.receivable_total_amount),
                      ...
                      vehicle_type=str(int(self.command_recv_set.info_b4['VehicleClass'],16))  # 收费车型
                      )
